...
io.on('connection', function (socket) {
    ...
    socket.on('joinAttempt', function (roomId, playerName) {
        ...
        socket.on('successfulMove', function (data) {
            ...
            let defeatedBlackPiecesFromOpponent = data.defeatedBlackPiecesToSend
            let defeatedWhitePiecesFromOpponent = data.defeatedWhitePiecesToSend
        ...
        socket.on('disconnect', function () {
            ...
            if (roomsDataObj[roomId].playerTwoId === '' && roomsDataObj[roomId].playerOneId === '') {
