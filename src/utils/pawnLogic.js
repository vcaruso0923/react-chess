  ...
  if (piecesLocation[firstClick].includes('pawn')) {
    ...
    if (piecesLocation[firstClick].includes('white-pawn')) {
      ...
      if (
        ...
        destinationNumber(secondClick) - pieceToMoveNumber(firstClick) > 1
      ) {
        return false;
      }
      ...
      if (
        firstClick.slice(-1) === '2' &&
        destinationNumber(secondClick) - pieceToMoveNumber(firstClick) > 2
      ) {
        return false;
      }
      ...
      if (
        ...
        pieceToMoveNumber(firstClick) - destinationNumber(secondClick) > 1
      ) {
        return false;
      }
      // Can't move more than two rows on first move
      if (
        firstClick.slice(-1) === '7' &&
        pieceToMoveNumber(firstClick) - destinationNumber(secondClick) > 2
      ) {
        return false;
      }
      // Can't move sideways
